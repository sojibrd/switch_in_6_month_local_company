...
- [ ] ৩০′ আজকের ঝালাই — ৬ ধাপে, জোরে 🧠 (Spaced repetition)
- [ ] ৩০′ আবেদন — সপ্তাহের ২য়
- [ ] ১৫′ ইংরেজি — *"How would you make this page faster?"* — ১ মিনিট
...
- [ ] ৩০′ আজকের ঝালাই — ৬ ধাপে, জোরে 🧠 (Spaced repetition)
- [ ] ৩০′ আবেদন — সপ্তাহের ২য়
- [ ] ১৫′ ইংরেজি — browser-এর ছবিটা, না দেখে
...
- [ ] ৩০′ আজকের ঝালাই — ৬ ধাপে, জোরে 🧠 (Spaced repetition)
- [ ] ১৫′ LinkedIn বার্তা ×২
- [ ] ১৫′ ইংরেজি — `srdtube` ১০× হলে কী হবে, ১ মিনিট
...
> **দিন শেষে:** ব্লক ৫ — live coding-এর ৬ ধাপ মুখস্থ আর mock #২ হয়েছে?
