...
- **ফাইলে তারিখ নেই।** তারিখ = শুরুর তারিখ + (দিন − ১)। শুরুর তারিখ ব্রাউজারে; বসানো না থাকলে সাইট প্রথমবার জিজ্ঞেস করে — input-এ `app/lib/site.ts`-এর `suggestedStart` (২০২৬-০৯-১৪) বসানো থাকে।
...
- **Theme contract অলঙ্ঘনীয়, সাইট dark-only।** Tailwind শুধু লেআউটে; চেহারা role class আর `--t-*` টোকেনে। DSA-র প্রবলেম, নোট আর ঝালাই `dsa_prep_local_company`-এ; দিন ০৫০–০৭৭-এর system design [`system_design_local_company`](https://sojibrd.github.io/system_design_local_company/)-এ; দিন ০০৬–১৫৪-এর story-র কাজ [`behavioural_interview_local_company`](https://sojibrd.github.io/behavioural_interview_local_company/)-এ (ঐ সাইটের দিন = এই plan-এর দিন − ৫)।
...
| key | মান |
|---|---|
| `slc6:v1:start` | শুরুর তারিখ `"YYYY-MM-DD"`। না থাকলে সাইট জিজ্ঞেস করে |
